...
import com.wjw.lockview.GestureLockView.Mode;
	...
	protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
		...
		if (mGestureLockViews == null) {
			...
			for (int i = 0; i < mGestureLockViews.length; i++) {
				...
				mGestureLockViews[i] = new GestureLockView(getContext(), mNoFingerInnerCircleColor, mNoFingerOuterCircleColor, mFingerOnColor,
						mFingerUpColor);
