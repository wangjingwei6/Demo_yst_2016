...
public class ColorViewPagerActivity extends FragmentActivity
{
	private String[] mTitles = new String[] {"个人","简介", "评价", "相关" };
	private ViewPager mViewPager;
	private FragmentPagerAdapter mAdapter;
	private NewInstanceSimpleFragment[] mFragments = new NewInstanceSimpleFragment[mTitles.length];
	...
	protected void onCreate(Bundle savedInstanceState)
	{
		...
		setContentView(R.layout.customviewpager_colortitle_act);
	...
	private void initDatas()
	{
		...
		{
			mFragments[i] = (NewInstanceSimpleFragment) NewInstanceSimpleFragment.newInstance(mTitles[i]);
		}
