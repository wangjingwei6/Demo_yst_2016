...
public class ColorTrackView extends View {
	...
	public ColorTrackView(Context context, AttributeSet attrs) {
		...
		mText = ta.getString(R.styleable.ColorTrackView_trackview_text);
		...
		mDirection = ta.getInt(R.styleable.ColorTrackView_direction_track_view_viewpager, mDirection);
	...
	private void drawOriginTop(Canvas canvas, int r) {
		drawText_v(canvas, mTextOriginColor, (int) (mTextStartY + mProgress * mTextHeight), mTextStartY + mTextHeight);
	}

	private void drawChangeBottom(Canvas canvas, int t) {
		drawText_v(canvas, mTextChangeColor, (int) (mTextStartY + (1 - mProgress) * mTextHeight), mTextStartY + mTextHeight);
	}

	private void drawOriginBottom(Canvas canvas, int t) {
		drawText_v(canvas, mTextOriginColor, mTextStartY, (int) (mTextStartY + (1 - mProgress) * mTextHeight));
	}
